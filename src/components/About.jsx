...
const About = () => {
  return (
    <div>
      <section class="bg-white dark:bg-black sm:py-10 py-6 rounded-xl">
    <div class="container px-6 py-10 mx-auto">
        <div class="lg:-mx-6 lg:flex lg:items-center">
            ...
            <div class="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
                <p class="text-5xl font-semibold text-red-500 ">“</p>
                ...
                <h3 class="mt-6 text-lg font-medium text-red-500">Sacdeeya Sheeko</h3>
