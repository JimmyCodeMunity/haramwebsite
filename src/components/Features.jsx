...
const Features = () => {
  return (
    <div>
      <div class="container mx-auto max-w-5xl flex gap-12 flex-wrap items-start sm:py-16 py-6 justify-center md:justify-between">
    <div class="grid gap-4 justify-items-center text-center md:flex-1">
        <div class=" rounded-full border-8 border-red-500 p-4 ">
